 ...
 */
@WebListener
public class MichimichiListener implements ServletContextListener {

	/**
	 * Default constructor.
	 */
	public MichimichiListener() {
	...
	public void contextDestroyed(ServletContextEvent sce)  {
		...
		System.out.println("cafeshop: DB connection is close.");
	...
	public void contextInitialized(ServletContextEvent sce)  {
		...
		System.out.println("cafeshop: DB connection is done." + dbc);
		ServletContext sc = sce.getServletContext();
