...
Admin account = (Admin) request.getAttribute("account");
...
<body>
	<div id="wrap">
		...
		<!-- 編集 -->
		<form name="inputForm" action="/michimichi/AｄみｎEdit" method="post">
			<%
			if (account != null) {
			%>
 ...
 %>
				...
				<tr>
					...
					<td width="80%"><input type="password" name="pass"
						value="<%=account.getPassword()%>" size="20" required></td>
				</tr>
				<tr>
					<th width="20%">郵便番号</th>
		...
		<hr>
		<div id="opbtns">
			<a href="/michiichi/CtrlForCms?pge_id=0">管理ページ</a> <a
				href="/michimichi/CtrlForCms?pge_id=4">アカウント一覧</a>
		</div>
	</div>
